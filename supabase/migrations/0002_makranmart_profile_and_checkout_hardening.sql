drop policy if exists "makranmart profiles insert own" on public.makranmart_profiles;
create policy "makranmart profiles insert own"
  on public.makranmart_profiles for insert
  to authenticated
